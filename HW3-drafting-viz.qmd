...
large_wildfire %>%
  ...
  labs(x = "Year", y = "Count", title = "US Wildfire Incident Counts between 1984 and 2023") +
  theme_ipsum()
```

###Visualization to be included in a report
...
ggplot(data=wildfire_decade, width = 4, height = 4) + 
  ...
  theme(plot.title = element_text(size = 16, family="Times New Roman", face = "bold", margin = margin(b = 6)),
